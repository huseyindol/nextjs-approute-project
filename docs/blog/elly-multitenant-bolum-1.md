...
seriesPart: 1
tags: ["multitenant", "spring-boot", "nextjs", "saas", "mimari"]
description: "Elly'de tenant routing'i nereye koyacağıma üç farklı kez karar verdim. Her seferinde yanıldığımı anladım — ve bu sayede temiz bir çözüme ulaştım. Bu yazı serisinin ilk bölümü."
---

# Multi-Tenant SaaS'ta Tenant Routing'i Nereye Koyacağıma 3 Kez Karar Verdim

> **Bu yazı 3 bölümlük bir serinin ilk bölümü.**
> **Bölüm 1:** Tenant Routing Kararları *(buradasınız)*
