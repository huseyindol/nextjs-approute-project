...
description: "Next.js'te multi-tenant frontend yazarken React Context API ile bir TenantProvider yazmak ilk içgüdü. Ama tenant bilgisi gibi cookie'de yaşayan bir veri için provider gerçekten gerekli mi? Multi-tenant mimari serisinin son bölümü."
...
> **Bölüm 3:** Frontend'de Tenant Context _(buradasınız)_
