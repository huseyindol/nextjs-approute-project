...
import { CRANE_ARCADE_ASSET_CACHE_KEY } from '@/lib/crane-arcade-asset-version.generated'
...
export function CraneArcadeGameFrame() {
  ...
  return (
    ...
    >
      ...
      <iframe
        title="Crane Arcade Oyunu"
        src={`/assets/games/crane-arcade/index.html?v=${CRANE_ARCADE_ASSET_CACHE_KEY}`}
