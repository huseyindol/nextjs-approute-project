...
import { WET_PAINT_ASSET_CACHE_KEY } from '@/lib/wet-paint-asset-version.generated'
...
export function WetPaintGameFrame() {
  ...
  return (
    ...
    >
      ...
      <iframe
        title="Wet Paint Oyunu"
        src={`/assets/games/wet-paint/index.html?v=${WET_PAINT_ASSET_CACHE_KEY}`}
