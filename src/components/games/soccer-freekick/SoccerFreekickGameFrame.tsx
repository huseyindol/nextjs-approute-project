...
import { SOCCER_FREEKICK_ASSET_CACHE_KEY } from '@/lib/soccer-freekick-asset-version.generated'
...
export function SoccerFreekickGameFrame() {
  ...
  return (
    ...
    >
      ...
      <iframe
        ...
        src={`/assets/games/soccer-freekick/index.html?v=${SOCCER_FREEKICK_ASSET_CACHE_KEY}`}
