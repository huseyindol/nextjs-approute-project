...
export default function MatchingGamePage() {
  return (
    <>
      <Seo
        rawTitle="Eğitici Eşleştirme Oyunu | Hüseyin DOL"
        description="Godot 4 web export ile hazırlanmış okul öncesi eşleştirme oyunu: renkler, hayvanlar ve meyveler. 24 seviye, ebeveyn paneli ve tarayıcıda tam ekran oynanış."
        canonical="/games/matching"
      />
