  ...
  if (success) {
    return (
      <>
        <Seo
          title="Kayıt Ol"
          description="Hüseyin DOL sitesine kayıt olun; Google veya GitHub ile de devam edebilirsiniz."
          canonical="/register"
          noIndex
        />
              ...
              <div className="flex flex-col items-center gap-4 text-center">
                ...
                <div>
                  ...
                  <p className="mt-2 text-sm text-muted-foreground">
                    <strong>{form.email}</strong> adresine bir doğrulama
                    e-postası gönderdik. Lütfen e-postanızdaki bağlantıya
                    tıklayarak hesabınızı etkinleştirin.
                  </p>
                </div>
